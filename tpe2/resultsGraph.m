 function resultsGraph(epocs, train_error, test_error, eta_adaptation, last_index, train_learning_rate)
   	clf;  hold on;
	plot(1:last_index, train_error(:,1:last_index), '-1; Error fase de entrenamiento;');
  	...
  	plot(1:last_index,train_learning_rate(:,1:last_index), '-4; Tasa de aciertos ;');
  	plot(epocs, 0);
